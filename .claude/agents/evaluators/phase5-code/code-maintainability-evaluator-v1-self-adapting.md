...
- Average: 12, Max: 20, 30% over threshold = 2.6/10.0
- Average: 8, Max: 45, 10% over threshold = 2.3/10.0
...
**Examples**:
- 2% duplication = 5.0/10.0
- 5% duplication = 4.5/10.0
- 12% duplication = 3.0/10.0
- 25% duplication = 2.0/10.0
...
```json
{
  ...
  "result": {
    "status": "PASS",
    "threshold": 3.5,
    "message": "Maintainability meets standards (4.1/10.0 ≥ 3.5)"
  }
}
```
