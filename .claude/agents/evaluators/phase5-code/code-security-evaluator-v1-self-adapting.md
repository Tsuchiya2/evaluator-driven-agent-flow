...
**Examples**:
- 0 vulnerabilities = 5.0/10.0
- 1 critical = 3.0/10.0
- 2 high = 3.0/10.0
- 1 critical + 2 high = 1.0/10.0
- 5 medium = 3.5/10.0
...
**Examples**:
- No secrets = 5.0/10.0
- 1 API key (high confidence) = 3.5/10.0
- 1 private key = 3.0/10.0
- Multiple secrets = 0/10.0
...
```json
{
  ...
  "result": {
    "status": "FAIL",
    "threshold": 4.0,
    "message": "Security score 3.8/10.0 is below threshold 4.0"
  }
}
```
