...
**Examples**:
- 100% all metrics = 5.0/10.0
- 80% lines, 75% branches, 80% functions, 80% statements = 3.9/10.0
- 50% all metrics = 2.5/10.0
...
**Examples**:
- 70% unit, 20% integration, 10% e2e = 5.0/10.0 (perfect)
- 50% unit, 30% integration, 20% e2e = 3.3/10.0
- 90% e2e, 10% unit, 0% integration = 1.2/10.0 (inverted pyramid)
...
```json
{
  ...
  "result": {
    "status": "PASS",
    "threshold": 3.5,
    "message": "Testing meets standards (4.3/10.0 ≥ 3.5)"
  }
}
```
...
✅ **Normalized Scoring** - All frameworks scored on same 0-10 scale
✅ **Zero Configuration** - Works out of the box
